...
export class CountryService {
  ...
  private queryCacheRegions = new Map<Region, Country[]>();
    ...
    return this.http.get<RESTCountry[]>(`${API_URL}/alpha/${code}`)
      .pipe(
        ...
        catchError((error) => {
          ...
          return throwError(() => new Error(`No se pudo obtener paises con ese code: ${code}`));
        })
      );
  }
    ...
    return this.http.get<RESTCountry[]>(`${API_URL}/region/${region}`)
      .pipe(
        ...
        catchError((error) => {
          ...
          return throwError(() => new Error(`No se pudo obtener paises por la región: ${region}`));
        })
      );
  }
